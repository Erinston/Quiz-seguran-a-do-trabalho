...
res.write('</head>');
res.write('<link rel="stylesheet" href="index.css">');
res.write('<embed src="mus.mp3" hidden="true" loop="infinite" autostart="TRU">');
...
app.post("/respostas", function (req, res) {
	...
	for(var contador = 0; contador < respostaFront.length; contador++) {
        ...
        res.write('<link rel="stylesheet" href="/resposta.css" media="screen" charset="utf-8">');
        res.write('<meta charset="UTF-8">');
	...
	//res.send("RESPOSTAS DO USUARIO : " + req.body.p1 + req.body.p2 + req.body.p3 + req.body.p4 + req.body.p5 + req.body.p6 + req.body.p7 + req.body.p8)
...
res.write('<head>');
res.write('<meta charset="utf-8">');
res.write('<link rel="stylesheet" href="jogoquiz.css">');
res.write('<embed src="rhcp.mp3" hidden="true" loop="infinite" autostart="TRU">');
...
res.write('<link rel="stylesheet" href="Desenvolvedores.css">');
res.write('</head>');
...
res.write('<head>');
	res.write('<meta charset="UTF-8">');
	res.write('<link rel="stylesheet" href="comojogar.css">');
